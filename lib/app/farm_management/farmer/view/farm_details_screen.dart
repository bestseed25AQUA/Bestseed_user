...
class FarmerDetailsFormScreen extends StatefulWidget {
  const FarmerDetailsFormScreen({super.key});

  @override
  State<FarmerDetailsFormScreen> createState() =>
      _FarmerDetailsFormScreenState();
}
